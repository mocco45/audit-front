            ...
            <form @submit.prevent="register">
                ...
                <div class="grid grid-cols-2 space-x-3 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="password" id="password" @input="clearError('password')"
                            class="rounded-full w-full border border-gray-400 px-3 py-2 shadow-lg focus:outline-none"
                    ...
                    <div>
                        ...
                        <input type="password" id="cpassword" @input="clearError('cpassword')"
                            class="rounded-full w-full border border-gray-400 px-3 py-2 shadow-lg focus:outline-none"
                            v-model="cpassword" placeholder="Confirm Password">
